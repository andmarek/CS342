...
public interface AST {
	...
	/**
	 * An isList expression has the syntax
	 *
	 * ( isList expression )
	 *
	 * @author samantha
	...
	public static class AndExp extends BinaryComparator {
		public AndExp(Exp first_exp, Exp second_exp) {
			super(first_exp, second_exp);
		}
	...
	public static class OrExp extends BinaryComparator {
		public OrExp(Exp first_exp, Exp second_exp) {
			super(first_exp, second_exp);
		}
	...
	public interface Visitor <T> {
		...
		public T visit(AST.IsListExp e, Env env); // Additional expressions for convenience
		public T visit(AST.AndExp e, Env env); // Added for HW5 Q3
		public T visit(AST.OrExp e, Env env); // Added for HW5 Q3
	}
}
